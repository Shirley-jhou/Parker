...
public class CollectRecycleAdapter extends RecyclerView.Adapter<CollectRecycleAdapter.myViewHodler> {
    ...
    public myViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
        //创建自定义布局
        View itemView = View.inflate(context, R.layout.record_list, null);
...
//        holder.mItemGoodsImg;
    ...
    class myViewHodler extends RecyclerView.ViewHolder {
        ...
        public myViewHodler(View itemView) {
            ...
            mItemGoodsName = (TextView) itemView.findViewById(R.id.rode);
            mItemGoodsPrice = (TextView) itemView.findViewById(R.id.record_date);
